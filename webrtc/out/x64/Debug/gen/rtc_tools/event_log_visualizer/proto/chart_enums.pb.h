...
enum ChartStyle_Type {
  ...
  ChartStyle_Type_ChartStyle_Type_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf_webrtc::kint32min,
  ChartStyle_Type_ChartStyle_Type_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf_webrtc::kint32max
};
...
const ::google::protobuf_webrtc::EnumDescriptor* ChartStyle_Type_descriptor();
...
inline bool ChartStyle_Type_Parse(
  ...
  return ::google::protobuf_webrtc::internal::ParseNamedEnum<ChartStyle_Type>(
    ChartStyle_Type_descriptor(), name, value);
}
// ===================================================================

class ChartStyle : public ::google::protobuf_webrtc::Message /* @@protoc_insertion_point(class_definition:webrtc.analytics.ChartStyle) */ {
 public:
  ChartStyle();
  virtual ~ChartStyle();
  ...
  ChartStyle* New(::google::protobuf_webrtc::Arena* arena) const final {
