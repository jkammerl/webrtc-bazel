...
using google::protobuf_webrtc::FieldDescriptor;
using google::protobuf_webrtc::Message;
using google::protobuf_webrtc::Reflection;
...
// built for production code.
  ...
  template <class T>
  void Visit(const google::protobuf_webrtc::RepeatedPtrField<T>& repeated_field);
  ...
  // array.
  void WriteArray(
      const google::protobuf_webrtc::RepeatedField<uint32_t>& repeated_field,
      const size_t size);
