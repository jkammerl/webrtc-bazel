...
using google::protobuf_webrtc::Descriptor;
using google::protobuf_webrtc::DescriptorProto;
using google::protobuf_webrtc::FileDescriptorProto;
using google::protobuf_webrtc::FieldDescriptorProto;
using google::protobuf_webrtc::Message;
using google::protobuf_webrtc::EnumValueDescriptorProto;
